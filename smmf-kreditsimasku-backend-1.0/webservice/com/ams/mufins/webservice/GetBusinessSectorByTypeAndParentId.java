...
public class GetBusinessSectorByTypeAndParentId extends Action {
	Logger log = Logger.getLogger(this.getClass());
	
	public static final String baseUrl = CommonDynamics.MUFINS_KREDITSIMASKU_BASE_URL;
	public static final String apiUrl = CommonDynamics.GET_BUSINESS_SECTOR_BY_TYPE_AND_PARENTID_API_URL;
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if ("GETBUSINESSSECTORBYTYPEANDPARENTID".equalsIgnoreCase(action)) {
			return this.performGetBusinessSectorByTypeAndParentId(mapping, form, request, response);
		}
		return null;
	}

	private ActionForward performGetBusinessSectorByTypeAndParentId(ActionMapping mapping, ActionForm form, HttpServletRequest request,
