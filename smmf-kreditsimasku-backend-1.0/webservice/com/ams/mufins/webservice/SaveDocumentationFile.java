...
public class SaveDocumentationFile extends Action {
	...
	private ActionForward performSaveDocumentationFile(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			log.info("\t---SaveDocumentationFile Request data : --username : "+jsonObject.getString("username")!=null?jsonObject.getString("username"):""+", category : "+jsonObject.getString("category")!=null?jsonObject.getString("category"):""+", applicationOnlineId : "+jsonObject.getInt("applicationOnlineId")+"---");
			if (jsonObject == null 
	...
	private ActionForward returnResponse(HttpServletResponse response, String responseMessage, int responseStatus, String rs) {
		try {
			...
			log.info("---SaveDocumentationFile Response data : "+result+"---");
