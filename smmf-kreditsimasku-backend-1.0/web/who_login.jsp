            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td nowrap="nowrap" bgcolor="#1e272d" class="borderLeft text05 padding"><bean:message key="server"/></td>
                  <td nowrap="nowrap" bgcolor="#1e272d" class="borderLeft text05 padding"><bean:message key="client"/></td>
                  <td nowrap="nowrap" bgcolor="#1e272d" class="borderLeft text05 padding"><bean:message key="page.userType.title"/></td>
                  <td nowrap="nowrap" bgcolor="#1e272d" class="borderLeft text05 padding"><bean:message key="page.userName.title"/></td>
                  <td nowrap="nowrap" bgcolor="#1e272d" class="borderLeft text05 padding"><bean:message key="page.browser.title"/></td>
                  <td nowrap="nowrap" bgcolor="#1e272d" class="borderLeft text05 padding"><bean:message key="login"/></td>
                  <td nowrap="nowrap" bgcolor="#1e272d" class="borderLeft text05 padding"><bean:message key="aksesTerakhir"/></td>
...
%>
                <logic:iterate id="s" name="list" type="com.ams.mufins.model.UserStream">
                <logic:present name="s" property="userName" scope="page">
					<% 
						sequence++;
					...
					<tr bgcolor="<% out.print(bgcolor); %>">
	                	<td class="Cell" align="right"><%=++i%>.</td>
	                  	<td class="Cell"><bean:write name="s" property="server" scope="page"/></td>
	                  	<td class="Cell"><bean:write name="s" property="ip" scope="page"/></td>
	                  	<td class="Cell"><bean:write name="s" property="userType" scope="page"/></td>
	                  	<td class="Cell"><bean:write name="s" property="userName" scope="page"/></td>
	                  	<td class="Cell"><bean:write name="s" property="browser" scope="page"/></td>
	                 	<td class="Cell"><bean:write name="s" property="formatedLoginTime" scope="page"/></td>
	                 	<td class="Cell"><bean:write name="s" property="formatedLastTime" scope="page"/></td>
	                 	<logic:present scope="session" name="user">
							<td class="Cell">
								<a href="<html:rewrite page="/releaseRemote.do"/>?userName=<bean:write name="s" property="userName" scope="page"/>&caller=/whoLoginRemote.do"><html:img page="/images/stop_16.gif" border="0"/></a>
							</td>
      					</logic:present>
             		</tr>
                </logic:present>
