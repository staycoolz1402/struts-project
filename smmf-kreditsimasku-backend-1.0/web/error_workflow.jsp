						  ...
						  <tr>
						  	<td>
						  		...
						  		<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr valign="top">
											<td align="center">
												<b>Your request can't be processed!</b><br></br>
												1. Maybe you don't have privilages on this action.<br></br>
												2. No routing of workflow con continue this action.<br></br>
												Contact your admin to fix this problem.<br>
											</td>
										</tr>
									</table>
