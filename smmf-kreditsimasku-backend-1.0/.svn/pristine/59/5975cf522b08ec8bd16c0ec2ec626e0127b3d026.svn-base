...
public class GetLookupByCategory extends Action {
	Logger log = Logger.getLogger(this.getClass());
	
	public static final String baseUrl = CommonDynamics.MUFINS_KREDITSIMASKU_BASE_URL;
	public static final String apiUrl = CommonDynamics.GET_LOOKUP_BY_CATEGORY_API_URL;
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if ("GETLOOKUPBYCATEGORY".equalsIgnoreCase(action)) {
			return this.performGetLookupByCategory(mapping, form, request, response);
		}
		return null;
	}

	private ActionForward performGetLookupByCategory(ActionMapping mapping, ActionForm form, HttpServletRequest request,
