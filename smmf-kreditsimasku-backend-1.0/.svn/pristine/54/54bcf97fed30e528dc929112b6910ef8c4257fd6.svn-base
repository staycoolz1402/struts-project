...
public class GetWilayah extends Action {
	Logger log = Logger.getLogger(this.getClass());
	
	public static final String baseUrl = CommonDynamics.MUFINS_KREDITSIMASKU_BASE_URL;
	public static final String apiUrl = CommonDynamics.GET_WILAYAH_API_URL;
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if ("GETWILAYAH".equalsIgnoreCase(action)) {
			return this.performWilayah(mapping, form, request, response);
		}
		return null;
	}

	private ActionForward performWilayah(ActionMapping mapping, ActionForm form, HttpServletRequest request,
