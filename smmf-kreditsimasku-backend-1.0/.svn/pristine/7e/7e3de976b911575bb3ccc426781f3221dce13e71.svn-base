...
public class GetDealerRefundByLookupId extends Action {
	Logger log = Logger.getLogger(this.getClass());
	
	public static final String baseUrl = CommonDynamics.MUFINS_KREDITSIMASKU_BASE_URL;
	public static final String apiUrl = CommonDynamics.GET_DEALER_REFUND_BY_LOOKUPID_API_URL;
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if ("GETDEALERREFUNDBYLOOKUPID".equalsIgnoreCase(action)) {
			return this.performGetDealerRefundByLookupId(mapping, form, request, response);
		}
		return null;
	}

	private ActionForward performGetDealerRefundByLookupId(ActionMapping mapping, ActionForm form, HttpServletRequest request,
