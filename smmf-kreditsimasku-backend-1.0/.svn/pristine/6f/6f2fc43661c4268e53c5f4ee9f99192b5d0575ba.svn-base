...
public class GetAdminRefundFromAgency extends Action {
	Logger log = Logger.getLogger(this.getClass());
	
	public static final String BASE_URL = CommonDynamics.MUFINS_KREDITSIMASKU_BASE_URL;
	public static final String API_URL = CommonDynamics.GET_ADMIN_REFUND_FROM_AGENCY;
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if ("GETADMINREFUNDFROMAGENCY".equalsIgnoreCase(action)) {
			return performGetAdminRefundFromAgency(mapping, form, request, response);
		}
		return null;
	}

	private ActionForward performGetAdminRefundFromAgency(ActionMapping mapping, ActionForm form, HttpServletRequest request,
