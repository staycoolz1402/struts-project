...
public class HibernatePlugIn implements PlugIn {
	...
	//baca dialect file config
	
	private static String databaseDialect = "";
	
	public static String getDialect(){
		String isi = _RootDAO.configFile;
		Configuration configuration = new Configuration().configure(new File("/"+isi).getPath());
		String dialect = configuration.getProperty("dialect");
		setDatabaseDialect(dialect);
		return dialect.replace("org.hibernate.dialect.", "");
	}
	...
	public static void setDatabaseDialect(String databaseDialect) {
		HibernatePlugIn.databaseDialect = databaseDialect;
	}
